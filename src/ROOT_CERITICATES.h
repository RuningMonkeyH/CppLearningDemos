...
#ifndef CPPLEARNINGDEMOS_ROOT_CERITICATES_H
#define CPPLEARNINGDEMOS_ROOT_CERITICATES_H
...
load_root_certificates(ssl::context &ctx) {
    ...
    detail::load_root_certificates(ctx, ec);
    if (ec)
        std::cerr << "load_root_certificates Error: " << ec.message() << std::endl;
}

#endif //CPPLEARNINGDEMOS_ROOT_CERITICATES_H
